      ...
      <div class="container">
        <div class="row">
          <div class="col-lg-6 mb-5 ftco-animate">
            <a href="{{asset('public')}}/images/kkaif.jpg" class="image-popup"><img src="{{asset('public')}}/images/kkaif.jpg" class="img-fluid" alt="Colorlib Template"></a>
          </div>
          <div class="col-lg-6 product-details pl-md-5 ftco-animate">
            ...
            <div class="rating d-flex">
              ...
              <p class="text-left">
                <a href="#" class="mr-2" style="color: #000;">Berat : <span style="color: #000;">{{$produk->berat}} gr</span></a>
              </p>
            </div>
            ...
            <div class="row mt-4">
              ...
              <div class="w-100"></div>
              <div class="col-md-12">
                <p style="color: #000;">{{$produk->berat}} gr</p>
              </div>
            </div>
