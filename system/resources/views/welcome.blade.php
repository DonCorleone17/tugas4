...
<html lang="en">
  <head>
    <title>BANGSAT.id | Marketplace Terpercaya Untuk Anda</title>
    <meta charset="utf-8">
        ...
        <div class="container">
            <div class="row">
                <div class="col-md-6 col-lg-3 ftco-animate">
                    <div class="product">
                        <a href="#" class="img-prod"><img class="img-fluid" src="{{asset('public')}}/images/product-1.jpg" alt="Colorlib Template">
